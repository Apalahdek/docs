...
**Soal Nomor 3:**
> Nilai ujian psikotes peserta seleksi Olimpiade SAINS tingkat SMP diperlihatkan dalam tabel berikut.
>
>| Nilai | 4 | 5 | 6 | 8 | 9 |
>|-------|---|---|---|---|---|
>| Frekuensi | 4 | 6 | 8 | 18 | 12 |
>
> Jika peserta yang dinyatakan masuk seleksi hanya peserta yang nilainya lebih besar atau sama dengan nilai rata-rata, berapa banyak peserta yang lolos seleksi?

### Cara dan Jawaban:

**1. Hitung Nilai Rata-Rata:**

Rumus rata-rata adalah jumlah semua nilai dibagi dengan banyaknya data.
\[
...
\[
(4 \times 4) + (5 \times 6) + (6 \times 8) + (8 \times 18) + (9 \times 12) = 16 + 30 + 48 + 144 + 108 = 346
\]
...
- Hitung rata-rata:
\[
\text{Mean} = \frac{346}{48} \approx 7.21
\]

**2. Tentukan Banyaknya Peserta yang Nilainya Lebih Besar atau Sama dengan Rata-Rata:**

Nilai yang lebih besar atau sama dengan rata-rata (7.21) adalah 8 dan 9.

- Frekuensi nilai 8: 18
- Frekuensi nilai 9: 12

Jadi, jumlah peserta yang lolos seleksi:
\[
18 + 12 = 30
\]

### Jawaban:
- **Banyak peserta yang lolos seleksi:** 30

Jika ada soal lain yang perlu dikerjakan atau ada penjelasan lebih lanjut yang dibutuhkan, silakan beri tahu saya.
